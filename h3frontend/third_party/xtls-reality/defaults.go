...
func defaultCurvePreferences() []CurveID {
	...
	default:
		// C-gamma: align supported_groups with the Go 1.24/1.25 baseline
		// (5 groups, keeping only the X25519MLKEM768 hybrid and the four
		// classic curves). The two additional PQ combos introduced in Go 1.26
		// are dropped so the QUIC ClientHello matches a widely-deployed
		// regular quic-go baseline.
		return []CurveID{
