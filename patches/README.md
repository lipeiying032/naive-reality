...
|---|---|---|
| `native-h3` (default) | 005 | Standard TLS; only rejects incompatible configuration |
...
file set to be exactly `src/net/tools/naive/naive_config.cc`. No BoringSSL, QUICHE,
